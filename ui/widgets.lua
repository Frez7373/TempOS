...
local M={}
function M.button(x,y,w,label,active) T.fill(x,y,x+w-1,y,active and T.accent or T.panel); T.text(x+1,y,(label or ""):sub(1,w-2),T.fg); return {x=x,y=y,w=w,h=1} end
