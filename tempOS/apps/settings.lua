...
local function run()
  while true do
    local c=S.get(); ui.clear(); ui.header("Settings")
    print(" Computer: "..tostring(c.computerName)); print(" ID: "..os.getComputerID()); print(" Version: "..tostring(c.version)); print(" Security lock: "..tostring(c.lockEnabled)); print("")
    ui.button(2,8,24,"Computer name",false); ui.button(28,8,24,"Password",false); ui.button(2,10,24,"Toggle lock",false); ui.button(28,10,24,"System info",false); ui.button(2,12,24,"Reset settings",false); ui.button(28,12,24,"Back",true); ui.footer("Touch/click or press Q")
    ...
    if e=="key" and a==keys.q then return elseif e=="monitor_touch" or e=="mouse_click" then x,y=b,c2
      ...
      elseif ui.hit(2,12,24,1,x,y) then local v=ui.input("Reset Settings","Type RESET to confirm:",""); if v=="RESET" then S.save(defaults()); pcall(os.setComputerLabel,"TempComputer"); ui.message("Settings","Settings restored to defaults.") end
